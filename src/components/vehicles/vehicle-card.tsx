...
export default function VehicleCard({ vehicle }: VehicleCardProps) {
  return (
    <motion.div
      ...
      viewport={{ once: false }}
      className="group bg-card border border-border/40 rounded-[3rem] overflow-hidden hover:border-primary/40 transition-all duration-500 shadow-sm hover:shadow-2xl hover:shadow-primary/5 relative"
    >
      {/* Image Container */}
      <div className="relative aspect-[16/11] overflow-hidden bg-muted m-3 rounded-[2.5rem]">
        <Image
          ...
          className="object-cover transition-transform duration-1000 group-hover:scale-110 rounded-[2.5rem]"
        />
      ...
      <div className="px-8 pb-8 pt-4">
        <div className="flex justify-between items-start mb-6">
          <div>
            <h3 className="text-2xl md:text-3xl font-bold tracking-tight mb-1 group-hover:text-primary transition-colors line-clamp-1">
          ...
          <div className="text-right">
            <div className="flex items-baseline gap-1">
              <span className="text-2xl md:text-3xl font-bold text-primary">${vehicle.daily_rent_price}</span>

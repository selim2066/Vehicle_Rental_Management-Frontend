    ...
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(
            "z-50 max-h-(--available-height) w-(--anchor-width) min-w-32 origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-[1.5rem] bg-popover/80 backdrop-blur-xl p-2 text-popover-foreground shadow-2xl ring-1 ring-white/10 duration-200 outline-none",

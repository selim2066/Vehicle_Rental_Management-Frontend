...
export default function Loading() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background">
      ...
      >
        <p className="text-2xl font-heading font-bold tracking-tight">Initializing <span className="text-primary italic">Vroom</span></p>
        <p className="text-muted-foreground text-sm font-medium mt-1">Preparing your premium experience...</p>
      </motion.div>
    </div>
  );
}
